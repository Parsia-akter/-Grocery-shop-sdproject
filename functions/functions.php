...
$db = mysqli_connect("localhost","root","","170204011");
...
function getPro(){
    ...
    while($row_products=mysqli_fetch_array($run_products)){
        ...
        <div class='col-md-4 col-sm-6 single' style='height:432px; margin-bottom:20px;'>
        
            <div class='product' style='height:432px; margin-bottom:20px;'>
